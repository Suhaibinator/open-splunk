...
func (AuditActorKind) Descriptor() protoreflect.EnumDescriptor {
	return file_open_splunk_audit_proto_enumTypes[0].Descriptor()
}

func (AuditActorKind) Type() protoreflect.EnumType {
	return &file_open_splunk_audit_proto_enumTypes[0]
}
...
func (AuditActorKind) EnumDescriptor() ([]byte, []int) {
	return file_open_splunk_audit_proto_rawDescGZIP(), []int{0}
}
...
func (AuditActorRole) Descriptor() protoreflect.EnumDescriptor {
	return file_open_splunk_audit_proto_enumTypes[1].Descriptor()
}

func (AuditActorRole) Type() protoreflect.EnumType {
	return &file_open_splunk_audit_proto_enumTypes[1]
}
...
func (AuditActorRole) EnumDescriptor() ([]byte, []int) {
	return file_open_splunk_audit_proto_rawDescGZIP(), []int{1}
}
...
var (
	AuditAction_name = map[int32]string{
		...
		10: "AUDIT_ACTION_APP_CREATE",
		11: "AUDIT_ACTION_APP_UPDATE",
...
func (AuditAction) Descriptor() protoreflect.EnumDescriptor {
	return file_open_splunk_audit_proto_enumTypes[2].Descriptor()
}

func (AuditAction) Type() protoreflect.EnumType {
	return &file_open_splunk_audit_proto_enumTypes[2]
}
...
func (AuditAction) EnumDescriptor() ([]byte, []int) {
	return file_open_splunk_audit_proto_rawDescGZIP(), []int{2}
}
...
func (AuditTargetKind) Descriptor() protoreflect.EnumDescriptor {
	return file_open_splunk_audit_proto_enumTypes[3].Descriptor()
}

func (AuditTargetKind) Type() protoreflect.EnumType {
	return &file_open_splunk_audit_proto_enumTypes[3]
}
...
func (AuditTargetKind) EnumDescriptor() ([]byte, []int) {
	return file_open_splunk_audit_proto_rawDescGZIP(), []int{3}
}
...
type AuditEvent struct {
	...
	ActorKind     AuditActorKind         `protobuf:"varint,3,opt,name=actor_kind,json=actorKind,proto3,enum=open_splunk.AuditActorKind" json:"actor_kind,omitempty"`
	ActorId       string                 `protobuf:"bytes,4,opt,name=actor_id,json=actorId,proto3" json:"actor_id,omitempty"`
	ActorRole     AuditActorRole         `protobuf:"varint,5,opt,name=actor_role,json=actorRole,proto3,enum=open_splunk.AuditActorRole" json:"actor_role,omitempty"`
	Action        AuditAction            `protobuf:"varint,6,opt,name=action,proto3,enum=open_splunk.AuditAction" json:"action,omitempty"`
	TargetKind    AuditTargetKind        `protobuf:"varint,7,opt,name=target_kind,json=targetKind,proto3,enum=open_splunk.AuditTargetKind" json:"target_kind,omitempty"`
	...
	ObjectType    *KnowledgeObjectType   `protobuf:"varint,11,opt,name=object_type,json=objectType,proto3,enum=open_splunk.KnowledgeObjectType,oneof" json:"object_type,omitempty"`
	SharingScope  *SharingScope          `protobuf:"varint,12,opt,name=sharing_scope,json=sharingScope,proto3,enum=open_splunk.SharingScope,oneof" json:"sharing_scope,omitempty"`
...
func (x *AuditEvent) Reset() {
	*x = AuditEvent{}
	mi := &file_open_splunk_audit_proto_msgTypes[0]
...
var File_open_splunk_audit_proto protoreflect.FileDescriptor

const file_open_splunk_audit_proto_rawDesc = "" +
	"\n" +
	"\x17open_splunk/audit.proto\x12\vopen_splunk\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x18open_splunk/common.proto\x1a\x1bopen_splunk/knowledge.proto\"\x83\x05\n" +
	"\n" +
	"AuditEvent\x12\x1a\n" +
	...
	"occurredAt\x12:\n" +
	"\n" +
	"actor_kind\x18\x03 \x01(\x0e2\x1b.open_splunk.AuditActorKindR\tactorKind\x12\x19\n" +
	"\bactor_id\x18\x04 \x01(\tR\aactorId\x12:\n" +
	"\n" +
	"actor_role\x18\x05 \x01(\x0e2\x1b.open_splunk.AuditActorRoleR\tactorRole\x120\n" +
	"\x06action\x18\x06 \x01(\x0e2\x18.open_splunk.AuditActionR\x06action\x12=\n" +
	"\vtarget_kind\x18\a \x01(\x0e2\x1c.open_splunk.AuditTargetKindR\n" +
	"targetKind\x12\x1b\n" +
	"\ttarget_id\x18\b \x01(\tR\btargetId\x12%\n" +
	"\x0etarget_version\x18\t \x01(\x04R\rtargetVersion\x12\x1a\n" +
	"\x06app_id\x18\n" +
	" \x01(\tH\x00R\x05appId\x88\x01\x01\x12F\n" +
	"\vobject_type\x18\v \x01(\x0e2 .open_splunk.KnowledgeObjectTypeH\x01R\n" +
	"objectType\x88\x01\x01\x12C\n" +
	"\rsharing_scope\x18\f \x01(\x0e2\x19.open_splunk.SharingScopeH\x02R\fsharingScope\x88\x01\x01B\t\n" +
	"\a_app_idB\x0e\n" +
	"\f_object_typeB\x10\n" +
	"\x0e_sharing_scope*m\n" +
	...
	"\x1eAUDIT_ACTION_INDEX_DELETE_DATA\x10\t\x12\x1b\n" +
	"\x17AUDIT_ACTION_APP_CREATE\x10\n" +
	"\x12\x1b\n" +
	...
	"\"AUDIT_TARGET_KIND_KNOWLEDGE_OBJECT\x10\x05BCZAgithub.com/Suhaibinator/open-splunk/gen/go/open_splunk;opensplunkb\x06proto3"

var (
	file_open_splunk_audit_proto_rawDescOnce sync.Once
	file_open_splunk_audit_proto_rawDescData []byte
)

func file_open_splunk_audit_proto_rawDescGZIP() []byte {
	file_open_splunk_audit_proto_rawDescOnce.Do(func() {
		file_open_splunk_audit_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_open_splunk_audit_proto_rawDesc), len(file_open_splunk_audit_proto_rawDesc)))
	})
	return file_open_splunk_audit_proto_rawDescData
}

var file_open_splunk_audit_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_open_splunk_audit_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_open_splunk_audit_proto_goTypes = []any{
	(AuditActorKind)(0),           // 0: open_splunk.AuditActorKind
	(AuditActorRole)(0),           // 1: open_splunk.AuditActorRole
	(AuditAction)(0),              // 2: open_splunk.AuditAction
	(AuditTargetKind)(0),          // 3: open_splunk.AuditTargetKind
	(*AuditEvent)(nil),            // 4: open_splunk.AuditEvent
	(*timestamppb.Timestamp)(nil), // 5: google.protobuf.Timestamp
	(KnowledgeObjectType)(0),      // 6: open_splunk.KnowledgeObjectType
	(SharingScope)(0),             // 7: open_splunk.SharingScope
}
var file_open_splunk_audit_proto_depIdxs = []int32{
	5, // 0: open_splunk.AuditEvent.occurred_at:type_name -> google.protobuf.Timestamp
	0, // 1: open_splunk.AuditEvent.actor_kind:type_name -> open_splunk.AuditActorKind
	1, // 2: open_splunk.AuditEvent.actor_role:type_name -> open_splunk.AuditActorRole
	2, // 3: open_splunk.AuditEvent.action:type_name -> open_splunk.AuditAction
	3, // 4: open_splunk.AuditEvent.target_kind:type_name -> open_splunk.AuditTargetKind
	6, // 5: open_splunk.AuditEvent.object_type:type_name -> open_splunk.KnowledgeObjectType
	7, // 6: open_splunk.AuditEvent.sharing_scope:type_name -> open_splunk.SharingScope
...
func init() { file_open_splunk_audit_proto_init() }
func file_open_splunk_audit_proto_init() {
	if File_open_splunk_audit_proto != nil {
		return
	}
	file_open_splunk_common_proto_init()
	file_open_splunk_knowledge_proto_init()
	file_open_splunk_audit_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_open_splunk_audit_proto_rawDesc), len(file_open_splunk_audit_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_open_splunk_audit_proto_goTypes,
		DependencyIndexes: file_open_splunk_audit_proto_depIdxs,
		EnumInfos:         file_open_splunk_audit_proto_enumTypes,
		MessageInfos:      file_open_splunk_audit_proto_msgTypes,
	}.Build()
	File_open_splunk_audit_proto = out.File
	file_open_splunk_audit_proto_goTypes = nil
	file_open_splunk_audit_proto_depIdxs = nil
}
