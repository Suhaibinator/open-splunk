...
export function auditActionFromJSON(object: any): AuditAction {
  switch (object) {
    ...
    case 31:
    case "AUDIT_ACTION_EXPORT_CREATE":
      return AuditAction.AUDIT_ACTION_EXPORT_CREATE;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function auditActionToJSON(object: AuditAction): string {
  switch (object) {
    ...
    case AuditAction.AUDIT_ACTION_EXPORT_CREATE:
      return "AUDIT_ACTION_EXPORT_CREATE";
...
export function auditTargetKindFromJSON(object: any): AuditTargetKind {
  switch (object) {
    ...
    case 8:
    case "AUDIT_TARGET_KIND_EXPORT_JOB":
      return AuditTargetKind.AUDIT_TARGET_KIND_EXPORT_JOB;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function auditTargetKindToJSON(object: AuditTargetKind): string {
  switch (object) {
    ...
    case AuditTargetKind.AUDIT_TARGET_KIND_EXPORT_JOB:
      return "AUDIT_TARGET_KIND_EXPORT_JOB";
