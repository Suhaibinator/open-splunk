...
CREATE TABLE audit_events_with_lookup (
    ...
    target_kind TEXT NOT NULL COLLATE BINARY CHECK (
        target_kind IN (
            ...
            'knowledge_object', 'server_settings', 'lookup'
        )
    ),
...
INSERT INTO audit_events_with_lookup (
...
ALTER TABLE audit_events_with_lookup RENAME TO audit_events;
