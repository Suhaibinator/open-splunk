...
const testFiles = [
  ...
  path.join("app", "reports", "saved-search-scope-editor.test.tsx"),
  ...
  path.join("app", "dashboards", "dashboard-visualization-model.test.ts"),
  path.join("app", "dashboards", "dashboard-visualization-adversarial.test.ts"),
  path.join("app", "dashboards", "dashboard-result-loader.test.ts"),
  path.join("app", "dashboards", "dashboard-result-loader-adversarial.test.ts"),
  path.join("app", "dashboards", "dashboard-visualization.test.tsx"),
  path.join("app", "dashboards", "dashboard-visualization-geometry.test.tsx"),
  path.join("app", "dashboards", "backend-dashboard-manager.test.tsx"),
  path.join("app", "admin", "admin-resource-data.test.ts"),
  path.join("app", "admin", "app-catalog-mutations.test.tsx"),
  path.join("app", "admin", "backend-admin-console-hec.test.ts"),
  path.join("app", "admin", "hec-operations.test.tsx"),
  path.join("app", "admin", "hec-operations-lifecycle.mount.test.tsx"),
  ...
  path.join("app", "search-workspace", "charts", "chart-scale.test.ts"),
  ...
  path.join("app", "search-workspace", "components", "workspace-dialogs-export-limit.test.tsx"),
  ...
  path.join("app", "search-workspace", "components", "saved-search-scope.test.tsx"),
  ...
  path.join("lib", "api", "client-request-id.test.ts"),
  ...
  path.join("lib", "api", "hec-operations-route.test.ts"),
  path.join("lib", "api", "app-catalog.test.ts"),
  ...
  path.join("lib", "search", "server-create-requests.test.ts"),
  ...
  path.join("lib", "search", "saved-search-scope.test.ts"),
