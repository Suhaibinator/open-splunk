...
test("synthetic clean R/E lineage passes accepted and ancestor verification", async (t) => {
  ...
  const receiptValues = new Map([
    ...
    ["clickhouse-gates", { runtime_revision: runtime, runtime_tree: runtimeTree, image: "clickhouse/clickhouse-server:26.3.17.4@sha256:85c434814ac8905e5648027ce926f74ab067edd6aadbccb6c0c165cd3571ea49", result: "pass" }],
