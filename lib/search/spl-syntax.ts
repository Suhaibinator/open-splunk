...
export const SPL_PIPELINE_COMMANDS = [
  ...
  },
  {
    ...
    detail: "Create or replace fields; if(predicate, true_value, false_value) selects between two values, coalesce(value, fallback, ...) selects the first non-null fixed value, case(predicate, value, ...) selects the value for the first true predicate, and lower(value)/upper(value) map a Unicode string or multivalue.",
  },
  {
    name: "rename",
