...
function DemoAdminConsole() {
  ...
  const primaryAction = section === "indexes"
    ? <button className="suite-button suite-button--primary" type="button" onClick={openIndexDialog}><AppIcon name="plus" size="sm" /> Simulate index</button>
    : section === "collectors"
...
function CollectorsSection() {
  return (
    <div className="admin-section-stack">
      ...
      <section className="suite-card token-section"><header className="suite-card-header"><div><h3>Issued credentials</h3><p>Sample records illustrating index-scoped ingestion tokens.</p></div></header><div className="table-wrap"><table className="table"><caption className="sr-only">Preview ingestion tokens</caption><thead><tr><th scope="col">Name</th><th scope="col">Prefix</th><th scope="col">Allowed indexes</th><th scope="col">Last used</th><th scope="col">Status</th><th scope="col"><span className="sr-only">Actions</span></th></tr></thead><tbody><tr><td><strong>prod-gradethis</strong></td><td><code>ospl_ing_a73…</code></td><td>gradethis</td><td>1 sec ago</td><td><span className="status-label status-label--complete"><i />Active</span></td><td><button className="row-overflow" type="button" aria-label="Actions for prod-gradethis"><AppIcon name="more" size="md" /></button></td></tr><tr><td><strong>platform-workers</strong></td><td><code>ospl_ing_2f1…</code></td><td>platform</td><td>3 sec ago</td><td><span className="status-label status-label--complete"><i />Active</span></td><td><button className="row-overflow" type="button" aria-label="Actions for platform-workers"><AppIcon name="more" size="md" /></button></td></tr></tbody></table></div></section>
    </div>
  );
}
