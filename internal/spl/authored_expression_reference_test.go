...
func TestAuthoredExpressionReferenceArithmeticFixtures(t *testing.T) {
	t.Parallel()
...
func TestAuthoredExpressionReferenceMembershipFixtures(t *testing.T) {
	t.Parallel()
...
func TestAuthoredExpressionReferenceNaNComparisons(t *testing.T) {
	t.Parallel()
...
func TestAuthoredExpressionReferenceEvaluationOrderAndOccurrence(t *testing.T) {
	t.Parallel()
...
func TestAuthoredExpressionReferenceArithmeticRandomized(t *testing.T) {
	t.Parallel()
...
func TestAuthoredExpressionReferenceMembershipRandomized(t *testing.T) {
	t.Parallel()
