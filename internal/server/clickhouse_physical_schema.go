...
// the complete table definition. On the version-pinned release server it covers
...
// settings cap adversarial metadata before validating the exact release-owned
// four-table contract.
...
// ValidateClickHousePhysicalSchemaForDatabase verifies the exact release-owned
...
func validateClickHousePhysicalSchemaForDatabase(
	...
	if tableCount != clickHouseReleaseOwnedTableCount || migrationLedgerCount != 1 || eventsCount != 1 ||
