...
func TestClassifyRouteCoversExactSurfaceAndNamespace(t *testing.T) {
	...
	tests := []struct {
		...
		{http.MethodPost, "/services/collector/event/0.4", EndpointUnknown, true, false, false, ErrorUnknownPath},
		{http.MethodPost, "/services/collector/raw", EndpointRaw, true, true, true, 0},
		{http.MethodPost, "/services/collector/raw/0.4", EndpointUnknown, true, false, false, ErrorUnknownPath},
		...
		{http.MethodGet, "/services/collector/health/0.4", EndpointUnknown, true, false, false, ErrorUnknownPath},
		...
		{http.MethodPost, "/services/collector/event/1.0", EndpointUnknown, true, false, false, ErrorUnknownPath},
		{http.MethodPost, "/services/collector/raw/1.0", EndpointUnknown, true, false, false, ErrorUnknownPath},
		{http.MethodGet, "/services/collector/health/1.0", EndpointUnknown, true, false, false, ErrorUnknownPath},
