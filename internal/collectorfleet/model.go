...
type fleetRecord struct {
	...
	// DisplayNameSortKey is generated by SQLite and must remain read-only.
	DisplayNameSortKey   string              `gorm:"column:display_name_sort_key;type:text;not null;->;index:collector_fleet_tenant_display_id_idx,priority:2"`
