...
type indexRecord struct {
	...
	MaxIngestEventsPerSecond            int64      `gorm:"column:max_ingest_events_per_second;type:integer;not null;check:indexes_max_ingest_events_per_second_bounded,max_ingest_events_per_second BETWEEN 0 AND 1000000"`
	MaxIngestUncompressedBytesPerSecond int64      `gorm:"column:max_ingest_uncompressed_bytes_per_second;type:integer;not null;check:indexes_max_ingest_uncompressed_bytes_per_second_bounded,max_ingest_uncompressed_bytes_per_second BETWEEN 0 AND 1099511627776"`
}
