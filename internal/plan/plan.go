...
// exact-field extrema/numeric-sum/average/distinct-count output supported by
// the bounded eventstats compatibility slice. Unlike Aggregate, it preserves
// row cardinality, event identity, established ordering, and every other
// visible field.
