...
func TestPipelineCommandsRejectPrivateOrdinalCollisionsDuringParsing(t *testing.T) {
	t.Parallel()
...
func TestPipelineForgedCommandsCannotBypassPrivateNamespaceDefense(t *testing.T) {
	t.Parallel()
...
func TestPipelineReservedFieldsPayloadRequiresAnExactUpstreamSchema(t *testing.T) {
	t.Parallel()
...
func TestPipelinePlanningBoundsRepeatedExpansionAndKeepsOrdinalPrivate(t *testing.T) {
	t.Parallel()
