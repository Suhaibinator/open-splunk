...
func TestV03TimelineAcceptsAccumAndAddInfoAsEventPreservingLowerings(t *testing.T) {
	tests := []string{
	...
	for _, source := range tests {
		t.Run(source, func(t *testing.T) {
			...
			scope.SearchJobID = "v03-timeline-job"
...
func TestV03TimelineLocatesAccumCanonicalTimeReplacementAtDestination(t *testing.T) {
