...
func TestPipelinePublicIndexRewritesStopPhysicalScopeInference(t *testing.T) {
	t.Parallel()
...
func TestPipelineNonIndexWritesDoNotHideForbiddenPhysicalIndexSelectors(t *testing.T) {
	t.Parallel()
