...
func TestPipelineCanonicalQuotedIdentifierRecognition(t *testing.T) {
	t.Parallel()
...
func TestPipelinePublicNamespaceOverlapUsesCanonicalPathSegments(t *testing.T) {
	t.Parallel()
...
func TestPipelineFillNullRepublishesInvalidPathStatsLiteralNamespaceOverlap(t *testing.T) {
	t.Parallel()
...
func TestPipelineCommonUpsertRepublishesPhysicalNamespaceOverlaps(t *testing.T) {
	t.Parallel()
...
func TestPipelineAuthoredPublishersRepublishDottedNamespaceOverlaps(t *testing.T) {
	t.Parallel()
...
func TestPipelineNamespaceOverlapDoesNotConflateEscapedLiteralDot(t *testing.T) {
	t.Parallel()
...
func TestPipelineFillNullFixedStringQualifiesEncodedPhysicalIdentifier(t *testing.T) {
	t.Parallel()
...
func TestPipelineFillNullNamespaceOverlapComposesWithConsumers(t *testing.T) {
	t.Parallel()
