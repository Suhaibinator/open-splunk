...
func TestCompileV03RetainedBytesSealsCanonicalJSONSettings(t *testing.T) {
	t.Parallel()
...
func TestCompileV03MakeMVRetainedBytesUsesLogicalNullForAbsentReplacement(t *testing.T) {
	t.Parallel()
...
func TestV03RetainedTupleUsesLogicalPresenceForPriorOptionalMultivalue(t *testing.T) {
	t.Parallel()
