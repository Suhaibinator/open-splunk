-- official SPL case: strcat.fields-and-literal
-- source: https://help.splunk.com/en/splunk-enterprise/search/spl-search-reference/10.0/search-commands/strcat (Syntax)
-- query: index=main | strcat source ":" sourcetype newfield
-- output_fields: _time, _raw, index, host, source, sourcetype, service, level, message, trace_id, span_id, event_id, _indextime, newfield
...
-- atomic_result: false
-- execution_authority_digest: 192639a90ad4d8a024350394d22d101b626e806b458dee9de406761622101a9d
-- args[0]: ":"
-- args[1]: "tenant-1"
-- args[2]: "main"
