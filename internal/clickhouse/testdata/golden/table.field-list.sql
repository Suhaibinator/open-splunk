-- official SPL case: table.field-list
-- source: https://help.splunk.com/en/splunk-enterprise/search/spl-search-reference/10.0/search-commands/table (Syntax)
-- query: index=main | table host source sourcetype
-- output_fields: host, source, sourcetype
-- sparse_fields: false subset=false
-- atomic_result: false
-- execution_authority_digest: f3173b621f1c1067324079949a7568a706d02608d3902e9c0f9651b4f1a137bc
-- args[0]: "tenant-1"
-- args[1]: "main"
