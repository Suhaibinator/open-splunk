-- official SPL case: chart.single-split
-- source: https://help.splunk.com/en/splunk-enterprise/search/spl-search-reference/10.0/search-commands/chart (Syntax)
-- query: index=main | chart count BY host
-- output_fields: host, count
-- sparse_fields: false subset=false
-- atomic_result: false
-- stats_partitions_max_threads: 1
-- execution_authority_digest: 0774cc76880433cddceba6eb27105cb12358863fe84669fd236774a9ab784817
-- args[0]: "tenant-1"
-- args[1]: "main"
