...
func TestEvaluateTruncatedLowerBounds(t *testing.T) {
	...
	tests := []struct {
		...
		{"less at boundary", ConditionLessThan, 2, 2, EvaluationIndeterminate},
		{"less above", ConditionLessThan, 3, 2, EvaluationIndeterminate},
		{"equal below", ConditionEqual, 1, 2, EvaluationIndeterminate},
		{"equal at boundary", ConditionEqual, 2, 2, EvaluationIndeterminate},
		{"equal above", ConditionEqual, 3, 2, EvaluationIndeterminate},
