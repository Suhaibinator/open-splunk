...
func TestPipelineRealMakeMVCompilerTransportPublishesNullEmptyAndOrderedMembers(t *testing.T) {
	t.Parallel()

	compiled := pipelineCompileRealMakeMVTransport(t)
...
func TestPipelineOptionalMultivalueTransportDistinguishesNullEmptyAndMembers(t *testing.T) {
	t.Parallel()
...
func TestPipelineOptionalMultivalueTransportRejectsForgedNativeValues(t *testing.T) {
	t.Parallel()
...
func TestPipelineOptionalMultivalueTransportRejectsLateForgedRowAtomically(t *testing.T) {
	t.Parallel()
...
func TestPipelineOptionalMultivalueTransportRejectsForgedHeadersTypesAndDescriptors(t *testing.T) {
	t.Parallel()
...
func pipelineOptionalMultivalueColumnTypes(
...
func pipelineCompileRealMakeMVTransport(t *testing.T) clickhouse.CompiledQuery {
	t.Helper()
	...
	logical, err := plan.Build(parsed, plan.Scope{
		TenantID:          "tenant-pipeline-transport",
