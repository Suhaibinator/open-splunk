...
// The pipeline compiler deliberately fails hostile runtime values with stable,
...
func TestPipelineRuntimeMarkersAreCompletelyClassifiedAndRedacted(t *testing.T) {
	t.Parallel()
