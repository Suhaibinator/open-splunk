...
func TestPipelineCommandsHaveACompleteRedactedInspectionProjection(t *testing.T) {
	t.Parallel()
...
func TestPipelineMissingMultivalueFieldKeepsInspectionAndLogicalShapeAligned(t *testing.T) {
	t.Parallel()
