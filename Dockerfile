...
FROM --platform=${BUILDPLATFORM} node:24.19.0-bookworm-slim@sha256:3638d9a6fe4030bd716be989438248074489337ba3275657f93595428be4fc03 AS ui
ARG OPEN_SPLUNK_APPLICATION_VERSION
ARG OPEN_SPLUNK_SOURCE_REVISION
ARG OPEN_SPLUNK_SOURCE_DATE_EPOCH
...
FROM --platform=${BUILDPLATFORM} golang:1.26.6-bookworm@sha256:116d58cbd88c1297624acc6e967a060012422bacf9930927e23fb719189c6f36 AS binaries
ARG TARGETOS
ARG TARGETARCH
